...
class Blog2 extends Component {
  render() {
    ...
    <main>
    <h1><center>How Nike landed Michael Jordan</center></h1>
    <center><img className="blog" src={process.env.PUBLIC_URL + '/jordan.jpg' } alt="Sports"  /></center>

    <p><b>Date: Feb 15, 2013</b></p>
	...
	"We’re sitting in the conference room and they’re saying things like, ‘We are basketball,’” Jordan's agent David Falk recalled. "They’re telling us that they have Magic, Bird, Dr. J and Mark Aguirre.”</p>


	<p>The Wild Card</p>

	<p>It was O.J. Simpson, of all people, who called it: Michael Jordan would be the best new star in sports.
	If Jordan had his druthers, he would have chosen adidas after leaving North Carolina.
	...
	So John H. Fisher, then Spot-Bilt's vice president of marketing, went to his father and asked him what to do.</p>


	<p>Nike Moves In</p>

	<p>Nike was a fast-rising star. The company's revenue went from $28.7 million in 1973 to $867 million by the end of 1983. But things had started to turn on them toward the end of the year. In February 1984, the company reported its first quarterly loss ever. The Olympics in Los Angeles that summer provided a nice morale boost -- most notably, Carl Lewis won four gold medals in Nikes -- but there wasn't an immediate translation in sales.
	...
	Knight was also killing the team business that was so profitable to Hyde’s Spot-Bilt brand by giving shoes to teams for free.</p>

	<p>Flying High</p>

	<p>In the coming weeks, Falk came up with the Air Jordan name and Nike was working hard to make a splash.
	No one comes close to selling as many shoes as Nike's Air Jordans.
	But first, Falk had to call Fisher to tell him that Jordan would not be wearing Spot-Bilt.</p>


	<p>So what would have happened if Spot-Bilt had landed Jordan?</p>
